...
| `reglas` | **Sin navegador.** Motor de reglas (`nucleo/reglas.js`, 31 reglas G·C·K). Sobre el CSV de referencia encuentra exactamente lo de la auditoría (4 errores, incluida la negativa amplia «comprar auto» que bloquea «comprar seguro de auto»); cada regla tiene su caso; una campaña sana da cero hallazgos. |
