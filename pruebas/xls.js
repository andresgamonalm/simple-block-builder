  ...
  const bytes = await pg.evaluate(()=>{
    ...
    pieza().adsData = { nombre:"Seguro Auto", urlFinal:"https://ejemplo.cl/auto",
      grupos:[{ nombre:"Cotizar seguro auto", intencion:"comprar", razonamiento:"transaccional",
        ...
        titularesFijos:["Matías Seguro Auto","Seguro Automotriz Online","2 Cuotas Gratis","Cotiza Aquí"],
        titulares:["Matías Seguro Auto","Seguro Automotriz Online","2 Cuotas Gratis","Cotiza Aquí","Cobertura Desde Hoy","Asistencia en Ruta"],
