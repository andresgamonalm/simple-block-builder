...
TODAS=(audita-estatica nucleo nucleo-contrato reglas versiones iniciativas login acceso ia-json ads-ia diagnostico geom medir insp panel arrastre libre proporciones escribir alcance iaq asis xls campana-actual fb tablet migra cierres regres recorrido)
descripcion() {
  case "$1" in
    ...
    reglas)    echo "motor de reglas: hallazgos exactos sobre el CSV de referencia y cada regla (sin navegador)";;
    ...
    escribir)  echo "escribir sobre el banner y que la IA genere en el lienzo libre";;
