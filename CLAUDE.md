...
## Roadmap / pendientes
0. **EN CURSO (elegido por el usuario):** subir el nivel de diseño de la IA con **(a) Plantillas de diseño por tipo de email** (esqueletos pre-armados comercial/newsletter/corporativo que la IA solo rellena con copy+foto) y **(b) Bloques más ricos** (features con ícono en círculo de color, secciones con fondo, hero con degradado, tarjetas con sombra). Idea futura: pedir al usuario 1-2 emails "bien diseñados" como referencia para clonar su estándar.
